<template>
	<tm-app>
		...
		<tm-sheet>
			...
			<tm-input v-model="testtext" confirm-hold confirm-type="换行" showCharNumber :maxlength="100" :border="1"
				color="grey-5" :height="80" type="textarea"></tm-input>
		</tm-sheet>
		<tm-sheet>
		...
		<tm-sheet>
			...
			<tm-input prefixLabel="聚焦样式" color="white" focusColor="red" :margin="[0,24]" prefix="tmicon-user-fill">
			</tm-input>
		</tm-sheet>
