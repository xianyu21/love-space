...
class themeColors {
  ...
  getTheme(config = { colorname: "primary", dark: false }) {
    ...
    if (nowColor.hsla.h == 0 && nowColor.hsla.s == 0 && config.dark) {
      css.backgroundColor = tmui_tool_theme_colortool.colortool.rgbaToCss(tmui_tool_theme_colortool.colortool.hslaToRgba(__spreadProps(__spreadValues({}, bghsl), { l: 8 })));
