...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.124.16"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/软件/HBuilderX.3.3.5.20211229/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"ol","spaceId":"mp-0186d3c5-2e26-4e87-beba-8e07ffd2b7a5","clientSecret":"ZEe9r9o/bdzCyYgo713qcQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__34D7288";
} catch (e2) {
