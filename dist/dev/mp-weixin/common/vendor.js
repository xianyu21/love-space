...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.0.11",\n        "172.25.224.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "F:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"ol","spaceId":"mp-0186d3c5-2e26-4e87-beba-8e07ffd2b7a5","clientSecret":"ZEe9r9o/bdzCyYgo713qcQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__34D7288";
} catch (e2) {
